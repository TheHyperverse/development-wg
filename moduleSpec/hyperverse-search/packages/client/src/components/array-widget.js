...
export default class ArrayWidget extends LitElement {
    ...
    addNewInput() {
        ...
        <div class="flex">
            <label class="bg-gray-200 p-2 block rounded rounded-r-none text-gray-500" for="${this.field}-${this.count}">${this.label}</label>
    ...
    firstUpdated() {
        this.allFields = `
        <div class="flex">
            <label class="bg-gray-200 p-2 block rounded rounded-r-none text-gray-500" for="${this.field}-0">${this.label}</label>
