...
import HyperverseService from Hyperverse.HyperverseService
...
pub contract interface HyperverseInterface {
    ...
    // Defines ContractMetadata struct defined in HyperverseService.
    pub var contractMetadata: HyperverseService.ContractMetadata
